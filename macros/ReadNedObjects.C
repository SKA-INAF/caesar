...
int ReadNedObjects(std::string nedFileName,std::string regionFileName="",std::string outputFileName="output.root")
{
	//===================================
	//==       GET ARGS
	//===================================
	gCatalogFileName= nedFileName;
...
int ReadObjects()
{
	...
	int status= AstroObjectParser::ParseNedData(gAstroObjects,gCatalogFileName,'|');
	if(status<0){
