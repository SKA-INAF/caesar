...
int ReadAegeanObjects(std::string aegeanFileName,std::string regionFileName="",std::string outputFileName="output.root",std::string regionOutFileName="ds9.reg")
{
	//===================================
	//==       GET ARGS
	//===================================
	gCatalogFileName= aegeanFileName;
...
int ReadObjects()
{
	...
	int status= AstroObjectParser::ParseAegeanData(gAstroObjects,gCatalogFileName,' ');
	if(status<0){
