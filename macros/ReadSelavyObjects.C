...
int ReadSelavyObjects(std::string selavyFileName,std::string regionFileName="",std::string outputFileName="output.root",std::string regionOutFileName="ds9.reg")
{
	//===================================
	//==       GET ARGS
	//===================================
	gCatalogFileName= selavyFileName;
...
int ReadObjects()
{
	...
	int status= AstroObjectParser::ParseSelavyData(gAstroObjects,gCatalogFileName,' ');
	if(status<0){
