...
int ReadWRCatObjects(std::string wrFileName,std::string regionFileName="",std::string outputFileName="output.root",std::string regionOutFileName="ds9.reg")
{
	//===================================
	//==       GET ARGS
	//===================================
	gCatalogFileName= wrFileName;
...
int ReadObjects()
{
	...
	int status= AstroObjectParser::ParseWRCatData(gAstroObjects,gCatalogFileName,'|');
	if(status<0){
