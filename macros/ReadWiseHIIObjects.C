...
int ReadWiseHIIObjects(std::string wiseFileName,std::string regionFileName="",std::string outputFileName="output.root",std::string regionOutFileName="ds9.reg")
{
	//===================================
	//==       GET ARGS
	//===================================
	gCatalogFileName= wiseFileName;
...
int ReadObjects()
{
	...
	int status= AstroObjectParser::ParseWiseHIIData(gAstroObjects,gCatalogFileName,'|');
	if(status<0){
