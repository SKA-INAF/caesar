...
MESSAGE(STATUS "msgpack header dir: " $ENV{MSGPACK_DIR}/include) 

FIND_PATH(MSGPACK_INCLUDE_DIR 
		msgpack.hpp
    PATHS $ENV{MSGPACK_DIR}/include
		/usr/include
    /usr/include/msgpack
    /usr/local/include
...
MESSAGE(STATUS "msgpack header dir: " $ENV{MSGPACK_DIR}/lib) 


FIND_LIBRARY(MSGPACK_LIBRARY 
		NAMES msgpackc 
		PATHS $ENV{MSGPACK_DIR}/lib
		/usr/lib
    /usr/local/lib
