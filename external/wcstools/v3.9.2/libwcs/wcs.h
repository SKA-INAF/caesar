...
#define degrad(x)	((x)*WCS_PI/180.)
#define raddeg(x)	((x)*180./WCS_PI)
#define hrdeg(x)	((x)*15.)
#define deghr(x)	((x)/15.)
...
struct IRAFsurface {
  ...
  double *coeff;//[ncoeff]	/* pointer to coefficient vector */
  double *xbasis;//[xorder]	/* pointer to basis functions (all x) */
  double *ybasis;//[yorder]	/* pointer to basis functions (all y) */
};
