...
int ReadATNFPsrObjects(std::string psrFileName,std::string regionFileName="",std::string outputFileName="output.root",std::string regionOutFileName="ds9.reg")
{
	//===================================
	//==       GET ARGS
	//===================================
	gCatalogFileName= psrFileName;
...
int ReadObjects()
{
	...
	int status= AstroObjectParser::ParseATNFPsrData(gAstroObjects,gCatalogFileName,'|');
	if(status<0){
